...
loadBytesImage path = do
    ...
    let result = case img of
                    ...
                    Right img -> BytesImage (Data.Text.pack path) (BS.pack $ V.toList  (imageData img)) (M.Size (fromIntegral $ Codec.Picture.Types.imageWidth img) (fromIntegral $ Codec.Picture.Types.imageHeight img))
    case img of
